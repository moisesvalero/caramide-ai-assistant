import { $ as AstroError, N as NoImageMetadata, Z as UnsupportedImageFormat, j as MissingSharp } from "./errors-data_Cx6lmWwS.mjs";
import { v as detector } from "./path_-SLcs2SG.mjs";
import { o as __toESM } from "../entry.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_DoaVDMbu.mjs";
//#region node_modules/.pnpm/astro@7.0.0_@emnapi+core@1.10.0_@emnapi+runtime@1.11.1_@vercel+functions@3.7.2_jiti@2.7.0_rollup@4.62.2/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./lib_DboalEKK.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
	} catch {
